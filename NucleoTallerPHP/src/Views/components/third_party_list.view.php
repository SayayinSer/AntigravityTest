    ...
    <table class="w-full text-left">
        <thead>
            <tr class="text-[10px] font-black text-slate-400 uppercase tracking-widest border-b border-slate-50">
                <th class="pb-4 px-2">Proveedor del Servicio</th>
                <th class="pb-4 px-2">Descripción del Tercerizado</th>
                <th class="pb-4 px-2 text-right">Inversión ($)</th>
        ...
        <tbody class="divide-y divide-slate-50">
            ...
            <tr class="group hover:bg-slate-50/50 transition-colors">
                <td class="py-5 px-2">
                    <div class="font-black text-slate-700 text-sm flex items-center gap-2">
                        <span class="w-1.5 h-1.5 rounded-full bg-amber-400"></span>
                        <?= htmlspecialchars(strval($tp->provider_name ?? "")) ?>
                    </div>
                </td>
                <td class="py-5 px-2">
