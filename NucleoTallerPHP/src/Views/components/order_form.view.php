<div class="glass p-8 rounded-2xl shadow-2xl max-w-2xl mx-auto">
    ...
    <form hx-post="<?= htmlspecialchars(strval($base ?? "")) ?>/order/save" class="space-y-6">
        <div>
        ...
        <div class="flex gap-4 pt-4">
            ...
            <a href="<?= htmlspecialchars(strval($base ?? "")) ?>/" class="flex-1 bg-slate-100 text-slate-600 font-bold py-3 rounded-xl border border-slate-200 text-center hover:bg-slate-200 transition-all">
                Cancelar
            </a>
        </div>
    </form>
