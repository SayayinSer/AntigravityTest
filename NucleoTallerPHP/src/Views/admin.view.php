...
{% block title %}Tablas Maestras - Aliso Workflow{% endblock %}
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div class="space-y-10">
            ...
            <div class="card-premium">
                ...
                <form hx-post="<?= htmlspecialchars(strval($base ?? "")) ?>/admin/brand" class="flex gap-4 mb-8">
                ...
                <div class="space-y-2 max-h-60 overflow-y-auto pr-2 custom-scrollbar">
                    ...
                    <div class="flex justify-between items-center p-4 bg-slate-50/50 rounded-2xl border border-slate-100 group transition-all hover:bg-white hover:shadow-sm">
                        ...
                        <form hx-post="<?= htmlspecialchars(strval($base ?? "")) ?>/admin/brand/<?= htmlspecialchars(strval($b->id ?? "")) ?>/delete" class="opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            <div class="card-premium">
                ...
                <form hx-post="<?= htmlspecialchars(strval($base ?? "")) ?>/admin/type" class="flex gap-4 mb-8">
                ...
                <div class="space-y-2 max-h-60 overflow-y-auto pr-2 custom-scrollbar">
                    ...
                    <div class="flex justify-between items-center p-4 bg-slate-50/50 rounded-2xl border border-slate-100 group transition-all hover:bg-white hover:shadow-sm">
                        ...
                        <form hx-post="<?= htmlspecialchars(strval($base ?? "")) ?>/admin/type/<?= htmlspecialchars(strval($t->id ?? "")) ?>/delete" class="opacity-0 group-hover:opacity-100 transition-opacity">
        ...
        <div class="space-y-10">
            ...
            <div class="card-premium">
                ...
                <form hx-post="<?= htmlspecialchars(strval($base ?? "")) ?>/admin/tech" class="flex gap-4 mb-8">
                ...
                <div class="space-y-2 max-h-60 overflow-y-auto pr-2 custom-scrollbar">
                    ...
                    <div class="flex justify-between items-center p-4 bg-slate-50/50 rounded-2xl border border-slate-100 group transition-all hover:bg-white hover:shadow-sm">
                        ...
                        <form hx-post="<?= htmlspecialchars(strval($base ?? "")) ?>/admin/tech/<?= htmlspecialchars(strval($tech->id ?? "")) ?>/delete" class="opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            <div class="card-premium">
                ...
                <div class="mb-8">
                    ...
                    <form hx-post="<?= htmlspecialchars(strval($base ?? "")) ?>/admin/country" class="flex gap-3 mb-4">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <div class="bg-slate-100 px-3 py-1.5 rounded-xl border border-slate-200 text-xs font-bold text-slate-600 flex items-center gap-2 group">
                            ...
                            <form hx-post="<?= htmlspecialchars(strval($base ?? "")) ?>/admin/country/<?= htmlspecialchars(strval($c->id ?? "")) ?>/delete" class="inline">
                                <button type="submit" class="text-slate-300 hover:text-red-500 transition-colors" hx-confirm="¿Eliminar país?">✖</button>
                            </form>
                        </div>
                        <?php endforeach; ?>
                    </div>
                ...
                <div>
                    ...
                    <form hx-post="<?= htmlspecialchars(strval($base ?? "")) ?>/admin/province" class="grid grid-cols-3 gap-3 mb-4">
                    ...
                    <div class="flex flex-wrap gap-2 max-h-40 overflow-y-auto">
                        ...
                        <div class="bg-sky-50 px-3 py-1.5 rounded-xl border border-sky-100 text-[10px] font-black text-sky-700 flex items-center gap-2">
                            <?= htmlspecialchars(strval($p->name ?? "")) ?> <span class="text-sky-300 font-normal">(<?= htmlspecialchars(strval($p->country->name ?? "")) ?>)</span>
                             <form hx-post="<?= htmlspecialchars(strval($base ?? "")) ?>/admin/province/<?= htmlspecialchars(strval($p->id ?? "")) ?>/delete" class="inline">
                                <button type="submit" class="text-sky-300 hover:text-red-500 transition-colors" hx-confirm="¿Eliminar provincia?">✖</button>
                            </form>
                        </div>
                        <?php endforeach; ?>
                    </div>
