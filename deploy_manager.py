...
# PostgreSQL connection URL (auto-generated by deploy_manager.py)
SQLALCHEMY_DATABASE_URL = os.getenv("DATABASE_URL", "{db_url}")

# Fix for Render (uses postgres:// but SQLAlchemy needs postgresql://)
...
# Production PostgreSQL (auto-generated by deploy_manager.py)
SQLALCHEMY_DATABASE_URL = os.getenv("DATABASE_URL", "{db_url}")
